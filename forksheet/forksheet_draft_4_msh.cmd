...
IOControls {
	outputFile = "/home/cmc2374/EE316_Project/EE-316-Project/forksheet/forksheet_draft_4"
	EnableSections
}
...
Placements {
	Constant "ConstantProfilePlacement_p_drain" {
		...
		EvaluateWindow {
			Element = Cuboid [(0 -0.068 -0.028) (0.039 0 0)]
		}
	}
	Constant "ConstantProfilePlacement_p_source" {
		Reference = "ConstantProfileDefinition_2"
		EvaluateWindow {
			Element = Cuboid [(0 -0.068 0.028) (0.039 0 0.056)]
		}
	}
	Constant "ConstantProfilePlacement_n_source" {
		Reference = "ConstantProfileDefinition_3"
		EvaluateWindow {
			Element = Cuboid [(0.056 -0.068 0.028) (0.095 0 0.056)]
		}
	}
	Constant "ConstantProfilePlacement_n_drain" {
		Reference = "ConstantProfileDefinition_4"
		EvaluateWindow {
			Element = Cuboid [(0.056 -0.068 -0.028) (0.095 0 0)]
		}
	}
	Refinement "RefinementPlacement_p_drain" {
		Reference = "RefinementDefinition_p_drain"
		RefineWindow = Cuboid [(0 -0.068 -0.028) (0.039 0 0)]
	}
