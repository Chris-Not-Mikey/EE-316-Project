...
IOControls {
	outputFile = "/home/cmc2374/EE316_Project/EE-316-Project/forksheet/final_models/fsh_airgap"
	EnableSections
}
...
Definitions {
	...
	Constant "ConstantProfileDefinition_bulk" {
		Species = "BoronActiveConcentration"
		Value = 1e+15
	}
...
Placements {
	...
	Constant "ConstantProfilePlacement_p_bulk_1" {
		Reference = "ConstantProfileDefinition_bulk"
		EvaluateWindow {
			Element = region ["region_si_bulk_1"]
		}
	}
	Constant "ConstantProfilePlacement_p_bulk_2" {
		Reference = "ConstantProfileDefinition_bulk"
		EvaluateWindow {
			Element = region ["region_si_bulk_2"]
		}
	}
	Constant "ConstantProfilePlacement_p_bulk_bot" {
		Reference = "ConstantProfileDefinition_bulk"
		EvaluateWindow {
			Element = region ["region_si_bulk_bottom"]
		}
	}
